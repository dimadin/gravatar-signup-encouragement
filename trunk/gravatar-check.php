...
* 1) load gravatar 2) get it's headers 3) chech if status is 200 4) if isn't, return "no"
* Based on work from florinel2k at yahoo dot com (  http://php.net/file_exists#75720 ) and worldclimb at gmail dot com (  http://php.net/file_exists#76545 )
*/
